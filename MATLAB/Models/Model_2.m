...
% ================================================================
% Fractional RK-2 Simulation for Modified SCP Crime Model
% ================================================================
...
% ----------------------------
dS = @(S,C,P) A_eta ...
              - (alpha_eta .* S .* C) ./ (1 + beta .* S) ...
              + delta1_eta .* P ...
              - delta0_eta .* S;

dC = @(S,C)   (alpha_eta .* S .* C) ./ (1 + beta .* S) ...
              - l_eta .* C ...
              - delta0_eta .* C;
...
title(sprintf('Fractional RK-2 Modified SCP Model (\\eta = %.2f)', eta), ...
